...
public record DataScadenza(LocalDateTime dataOra) {


    public DataScadenza(LocalDateTime dataOra) {
        if (dataOra == null) {
            throw new ValidazioneException(DataScadenza.class.getSimpleName(), CodiceErrore.DATA_SCADENZA_NON_PUO_ESSERE_NULL.getCodice());
        }
